...
function Personal(){
    return (
        ...
        <section className='img_principal'>
            <img src="images/ourTeam.jpg" alt='the team'/>
            <h2>Meet the Team & Advisory Board</h2>
            <div className='teams'>
                <article className="info-snippet">
                    <div className=' image_team'>
                        <input type="image" className="info-snippet_img" img src='images/Charles.jpg' alt='team picture'/>
                ...
                <article className="info-snippet">
                    <div className=' image_team'>
                        <input type="image" className="info-snippet_img" img src='images/jeanphilippe.jpeg' alt='team picture'/>
                   ...
                   <article className="info-snippet">
                    <div className=' image_team'>
                        <input type="image" className="info-snippet_img" img src='images/blankphoto.jpg' alt='team picture'/>
                            <h4>Ralph Böhlke</h4>
